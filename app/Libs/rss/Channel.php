...
class Channel implements ChannelInterface
{
    ...
    public function asXML()
    {
        ...
        if(!!$this->image['title']){
            $xml->addChild('image');
            $xml->image->addChild('title',$this->image['title']);
            $xml->image->addChild('url',$this->image['url']);
            $xml->image->addChild('link',$this->image['link']);
        }
