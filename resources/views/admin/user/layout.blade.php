...
@section('style')<link href="{{ $_ENV['platform']['cdn'].elixir("css/admin.user.css") }}" rel="stylesheet">
@stop
@section('area')
    <div class="list-header">
        <div class="nav">
            <a class="{{$sub_active == 'user' ? 'active' : ''}}" href="/admin/user">成员管理</a>
            <a class="{{$sub_active == 'black' ? 'active' : ''}}" href="/admin/user/blacklist">黑名单</a>
        </div>
        <div class="nav-right">
