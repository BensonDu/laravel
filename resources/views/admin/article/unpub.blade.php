...
@section('table')
    <table>
        ...
        <tr>
            ...
            <th><span>作者</span></th>
            <th><span>身份</span></th>
            <th class="orderable" v-bind:class="orderby == 'create_time' ? order : ''" v-on:click="_order('create_time')"><span>投稿时间</span><em></em></th>
            <th><span>操作</span></th>
        </tr>
        </thead>
        <tbody>
                ...
                <div class="image">
                    ...
                    <div class="preview">
                        <div class="img" v-bind:class="article.image.progress.active ? 'loading' : ''">
                            <img v-bind:src="!article.image.val ? 'http://qiniu.cdn-chuang.com//default-upload-image.png' : article.image.val">
