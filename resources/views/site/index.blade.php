...
@endforeach
                            ...
                            <div class="social">
                                ...
                                <a class="inter like"><span>赞 {{$article->like}}</span></a>
                                <a class="inter collect"><span>收藏 {{$article->favorite}}</span></a>
                            </div>
                        </div>
                        <div class="image">
...
@foreach ($hot as $k => $article)
                    <div class="item">
                        ...
                        <h6><a href="/user/{{$article['user_id']}}"class="author">{{$article['author']}}</a><span class="time">{{$article['time']}}</span></h6>
