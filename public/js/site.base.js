...
(function(){
    ...
    window.view_nav_left.fold = function(){
        return dom.mid.css('left',60), dom.content.css('padding-left',310),dom.backgound.css('left',310), dom.filter.addClass('trans').removeClass('unfold');
    };

    window.view_nav_left.unfold = function(){
        return dom.mid.css('left',140),dom.content.css('padding-left',390),dom.backgound.css('left',390), dom.filter.addClass('trans').addClass('unfold');
    };
