...
;(function ($, window, document, undefined) {
    ...
    Embeds.prototype.parseUrl = function (url) {
        ...
        html = url.replace(/\n?/g, '')
            .replace(/^((http(s)?:\/\/)(v\.|\w\\.))(youku\.com\/v_show\/id_)(\w+==|\w+)(.*?$)/,'<div style="left: 0px; width: 100%; height: 0px; position: relative; padding-bottom: 62.5%;"> <iframe src="http://player.youku.com/embed/$6"  frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" style="top: 0px; left: 0px; width: 100%; height: 100%; position: absolute;"></iframe> </div>')
            .replace(/^((http(s)?:\/\/)(v\.|\w\\.))(qq\.com\/cover\/(\w+\/|\/))(\w+)(\.html(\?vid=)(\w+).*?$)/,'<div style="left: 0px; width: 100%; height: 0px; position: relative; padding-bottom: 62.5%;"> <iframe src="http://v.qq.com/iframe/player.html?vid=$10&auto=1"  frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" style="top: 0px; left: 0px; width: 100%; height: 100%; position: absolute;"></iframe> </div>');
